...
/**
 * The abstract class BinaryCommand implements the interface Command for binary
 ...
 */
public abstract class BinaryCommand<T extends Number> implements Command<T> {
	/*
	 * (non-Javadoc)
	 * 
	...
	/**
	 * Returns the CommandType.BINARY
	 * 
	 * @return the CommandType.BINARY
	 */
	@Override
