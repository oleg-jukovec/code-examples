...
/**
 * The class SqrtUnaryCommand extends the class UnaryCommand for the square
 * root function.
 * 
 ...
 */
final public class SqrtUnaryCommand<T extends Number> extends UnaryCommand<T> {
	 ...
	 */
	public SqrtUnaryCommand(CalcPrimitive<T> calcPrimitive) {
	...
	public void execute(Deque<String> deque) throws CalculatorException {
		...
		deque.addFirst(calcPrimitive.getString(calcPrimitive.sqrt(value)));
	}
	...
	public String toString() {
		return "SqrtUnaryCommand [calcPrimitive=" + calcPrimitive + "]";
	}
