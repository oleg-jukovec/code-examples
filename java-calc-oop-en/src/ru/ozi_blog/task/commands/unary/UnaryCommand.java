...
/**
 * The abstract class UnaryCommand implements the interface Command for unary
 ...
 */
public abstract class UnaryCommand<T extends Number> implements Command<T> {
	/*
	 * (non-Javadoc)
	 * 
	...
	/**
	 * Returns the CommandType.UNARY
	 * 
	 * @return the CommandType.UNARY
	 */
	@Override
