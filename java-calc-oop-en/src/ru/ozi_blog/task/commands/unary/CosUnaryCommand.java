...
/**
 * The class CosUnaryCommand extends the class UnaryCommand for the cosine
 * function.
 * 
 ...
 */
final public class CosUnaryCommand<T extends Number> extends UnaryCommand<T> {
	 ...
	 */
	public CosUnaryCommand(CalcPrimitive<T> calcPrimitive) {
	...
	public void execute(Deque<String> deque) throws CalculatorException {
		...
		deque.addFirst(calcPrimitive.getString(calcPrimitive.cos(value)));
	}
	...
	public String toString() {
		return "CosUnaryCommand [calcPrimitive=" + calcPrimitive + "]";
	}
